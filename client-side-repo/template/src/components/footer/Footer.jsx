...
const Footer = () => {
  return (
    <footer className="footer p-10 bg-neutral text-neutral-content flex justify-between lg:flex-row flex-col">
  <aside>
  ...
  <div>
   ...
   <h2 className=" text-lg font-semibold flex gap-3 "> <CiMail className=" mt-1 text-2xl"></CiMail> <span className=" hover:underline cursor-pointer">studyflewship@gmail.com</span></h2>
   <h2 className=" text-lg font-semibold flex gap-3 "> <CiPhone className=" mt-1 text-2xl"></CiPhone> <span className=" hover:underline cursor-pointer">+97149090000</span></h2>
  </div>
  <nav>
